<?php
//懶人法:可以不用每次都透過postman來生成程式碼，程式碼可以重複使用
//1.每天必須登錄一下訂便當網頁，獲取新cookie，把獲取的_ga=...之後全部複製貼到下方"cookie"部分，並且覆蓋，存檔即可爬出網頁內容(需透過原網站做登入)
//2.在一天使用中若不能爬蟲，只需登入原始訂便當網站網頁，複製"JSESSIONID="之後一串的變數到下方覆蓋貼上即可再次爬蟲(需要先透過原網站登入)
//3.總之，只需要更改"cookie"部分或"JSESSIONID"部分即可，其他可以重複使用程式碼
